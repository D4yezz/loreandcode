...
import { Chat01Icon, Loading03Icon } from "@hugeicons/core-free-icons";
...
function FallBack() {
  return (
    <main className="min-h-screen bg-white font-sora w-screen flex items-center justify-center gap-2 text-xl font-bold uppercase">
...
export default function ContactPage() {
  ...
  return (
    <Suspense fallback={<FallBack />}>
      <main id="hero" className="min-h-screen bg-white font-sora">
